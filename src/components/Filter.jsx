        ...
        {btns.map((item, id) => {
          ...
          return (
            <button
              ...
              } py-3 px-5 inline-block rounded-full border-[3px] transition-all duration-300 hover:bg-fourth border-solid border-fourth text-sm  md:text-lg font-semibold text-white`}
            >
              {name}
            </button>
          );
